...
namespace RChronoWM
{
    public partial class App : Application
    {
        ...
        public static  ObservableCollection<Sequence> lstSequences = new ObservableCollection<Sequence>();
        public static Sequence currentSequence;
        public static Exercice currentExercice;
        /// <summary>
        ...
        {
            lstSequences = new ObservableCollection<Sequence>();
            loadData();
        }
        ...
        public static Sequence getSequenceFromLstEditIndex(int index)
        {
            int pos = 0;
            Sequence seq;
            for (int i= 0 ; i < lstSequences.Count; i++)
            {
                seq = lstSequences[i];
                if (index == pos)
                    return seq;
        ...
        {
            lstSequences.Add(new Sequence());
            lstSequences.RemoveAt(lstSequences.Count - 1);
        }
    }
